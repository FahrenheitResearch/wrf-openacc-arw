...
! ... look-up table functions ...
 ...
 if (zolf .NE. zolf) then
    psim_stable = 0._kind_phys
    return
 endif
 if (zolf .EQ. 0._kind_phys) then
    psim_stable = 0._kind_phys
    return
 endif
 if (zolf .LT. 0._kind_phys) then
    psim_stable = psim_unstable(zolf)
    return
 endif
 nzol = int(zolf*100.)
 rzol = zolf*100. - nzol
...
!=================================================================================================================
 ...
 if (zolf .LT. 0._kind_phys) then
    psih_stable = psih_unstable(zolf)
    return
 endif
 nzol = int(zolf*100.)
 rzol = zolf*100. - nzol
...
!=================================================================================================================
 ...
 if (zolf .GT. 0._kind_phys) then
    psim_unstable = psim_stable(zolf)
    return
 endif
 nzol = int(-zolf*100.)
 rzol = -zolf*100. - nzol
...
!=================================================================================================================
 ...
 if (zolf .GT. 0._kind_phys) then
    psih_unstable = psih_stable(zolf)
    return
 endif
 nzol = int(-zolf*100.)
 rzol = -zolf*100. - nzol
