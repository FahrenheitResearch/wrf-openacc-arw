...
BENCH_REPORT(advance_w_rhs_tim)
BENCH_REPORT(advance_w_wsolve_tim)
BENCH_REPORT(advance_w_damp_tim)
BENCH_REPORT(advance_w_ph_tim)
...
BENCH_REPORT(rk_scalar_setup_tim)
BENCH_REPORT(rk_scalar_zero_tim)
BENCH_REPORT(rk_scalar_pd_adv_tim)
BENCH_REPORT(rk_scalar_pd_zero_flux_tim)
BENCH_REPORT(rk_scalar_pd_flux_tim)
BENCH_REPORT(rk_scalar_pd_limiter_tim)
BENCH_REPORT(rk_scalar_ieva_tim)
BENCH_REPORT(rk_scalar_diffuse_tim)
